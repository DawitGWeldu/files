...
import { WorkerSidebar } from "./_components/worker-sidebar";
import { WorkerNavbar } from "./_components/worker-navbar";
...
const CourseLayout = async ({
  ...
  const progressCount = await getProgress(user.id, worker.id);
  return (
